...
| pto.load | direct pointer load | tensor | ✅ | ❌ | ✅ | ✅ | — | emitted by `tensor.read`; replaces `pto.load_scalar` in PTOAS 0.64 |
| pto.store | direct pointer store | tensor | ✅ | ❌ | ✅ | ✅ | — | emitted by `tensor.write`; replaces `pto.store_scalar` in PTOAS 0.64 |
