...
| pto.load | direct pointer load | tensor | ✅ | ❌ | ✅ | ✅ | — | 由 `tensor.read` 发射；PTOAS 0.64 中替代 `pto.load_scalar` |
| pto.store | direct pointer store | tensor | ✅ | ❌ | ✅ | ✅ | — | 由 `tensor.write` 发射；PTOAS 0.64 中替代 `pto.store_scalar` |
